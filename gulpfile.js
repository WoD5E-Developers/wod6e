...
gulp.task('less', function () {
  return gulp
    ...
    .pipe(concat('wod6e-styling.css')) // Concatenate all CSS files into a single file
    .pipe(gulp.dest('./styling/')) // Output for the wod-styling.css file
})

// Watch tasks
gulp.task('watch-styling', function () {
  // Watch all less files for updates to CSS
  gulp.watch('./styling/**/*.less', gulp.series('less'))
})
