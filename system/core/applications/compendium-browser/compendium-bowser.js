...
export class CompendiumBrowserApplication extends HandlebarsApplicationMixin(ApplicationV2) {
  static DEFAULT_OPTIONS = {
    ...
    window: {
      ...
      title: 'WOD6E.APPLICATIONS.CompendiumBrowser',
      resizable: true
    },
    classes: ['wod6e', 'dialog-app', 'sheet', 'application', 'compendium-browser'],
    position: {
      width: 900,
      height: 500
    },
  ...
  constructor(application, options) {
    ...
    this.filters = {
      ...
      splats: {
        open: true,
        options: Object.entries(WOD6E.configs.Systems.getList({})).map(([id, system]) => {
          return {
            id,
            label: system.label,
            enabled: true
  ...
  _getHeaderControls() {
    ...
    controls.push({
      ...
      label: 'WOD6E.APPLICATIONS.ConfigureSources',
  ...
  static PARTS = {
    sidebar: {
      template: 'systems/wod6e/templates/core/applications/compendium-browser/sidebar.hbs',
      scrollable: ['.search-filters']
    },
    body: {
      template: 'systems/wod6e/templates/core/applications/compendium-browser/body.hbs',
  ...
  async _prepareContext() {
    ...
    const compendiumBrowserConfig = currentUser?.flags?.wod6e?.compendiumBrowser
