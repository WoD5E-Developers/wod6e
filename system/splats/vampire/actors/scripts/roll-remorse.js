...
export const _onRemorseRoll = async function (event) {
  ...
  WOD5eDice.Roll({
    basicDice: dicePool,
    title: game.i18n.localize('WOD6E.VTM.RollingRemorse'),
    selectors,
    actor,
    data: actor.system,
    ...
    callback: async (err, rollData) => {
      ...
      if (hasSuccess) {
        ...
        foundry.documents.ChatMessage.implementation.create({
          flags: {
            wod6e: {
              name: game.i18n.localize('WOD6E.VTM.RemorseFailed'),
              img: 'systems/wod6e/assets/icons/dice/vampire/bestial-failure.png',
              description: game.i18n.format('WOD6E.VTM.RemorseFailedDescription', {
                actor: actor.name
              })
            }
          }
